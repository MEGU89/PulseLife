      ...
      {request && (
        ...
        >
          {request.requestType === "organ" ? (
            <Panel className="space-y-3 border-amber-200 bg-amber-50">
              <h3 className="text-lg font-black tracking-tight text-slate-950">Organ requests are informational for donors</h3>
              <p className="text-sm leading-7 text-amber-900">
                This request is visible on the donor side, but scheduling is currently limited to blood requests. If your team needs organ workflow support, that request continues to live on the hospital side.
              </p>
            </Panel>
          ) : (
            <Panel>
